...
import useFetchOperadores from "./FetchOperadores";
...
const NuevaLlegada = (props) => {
  ...
  const { listaOperadores, fetchOperadores } = useFetchOperadores();
  ...
  return (
    <>
      ...
      <Form onSubmit={handleSubmit(onSubmit)} className="mt-0 overflow-y-none">
